(function() {
  ...
  _.filter = function(collection, test) {
    var arr = [];
    this.each(collection, function (val, index, list) {
      if (test(val, index, list)) {
        arr.push(val);
      }
    });
    return arr;
  ...
  _.reject = function(collection, test) {
   ...
   return _.filter(collection, untest);
  ...
  _.shuffle = function(array) {
    ...
    var shuffler = function(val, index) {
      var random = Math.floor((Math.random() * index));
      if (random !== index) {
        shuffled[index] = shuffled[random];
      } 
      shuffled[random] = array[index];
    }

    this.each(array, shuffler)
    return shuffled;
  };
